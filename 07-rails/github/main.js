...
var data = {
  ...
  "owner": {
    "login": "octokit",
    "id": 3430433,
    "avatar_url": "https://avatars3.githubusercontent.com/u/3430433?v=3",
    "gravatar_id": "",
  ...
  "updated_at": "2017-03-23T03:33:34Z",
  "pushed_at": "2017-03-15T13:13:59Z",
...
// $.ajax({
//   url: 'https://api.github.com/users/bazzat10',
//   method: 'get',
//   dataType: 'JSON'
// }).fail(function() {
//   $('<p>').appendTo('.output');
...
//
//
// }); // call back method. calling the .done and passing in a function
...
function createData(data) {
  $('<p>').text(data).appendTo('.output');
  Object.keys(data).forEach(function(key){ // forEach function has no index. it will interate through the array.
    $('<p>').text(key + ": " + data[key]).appendTo('.output');
  });
